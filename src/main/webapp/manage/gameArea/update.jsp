...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="../gameArea" >游戏区服管理</a></li>
            <li class="active">修改游戏区服</li>
        </ol>
    </div><!--/.row-->

    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">游戏区服管理</h1>
        </div>
    </div><!--/.row-->
    <div class="container-fluid main-content">
        <div class="widget-container fluid-height clearfix mwi1200">
            <div class="heading clearfix">
                <i class="icon-reorder"></i> 修改游戏区服 <i class="icon-reply pull-right" onclick="history.go(-1);"></i>
            </div>
            <div class="widget-content padded clearfix">
                <form id="actionform" class="form-horizontal" action="view/customerManage/contacts/index.jsp"
                    ...
                    <input type="hidden" id="area-id" name="game[id]" value="${gameArea.id}">

                    <div class="form-group field-contacts-name required">
                        <label class="control-label col-sm-2" for="area-name">游戏名字</label>

                        <div class="col-sm-8">
                            <input type="text" id="area-name" class="form-control" name="Contacts[name]"
                                   maxlength="20" placeholder="请输入区服名字" value="${gameArea.areaName}">
                        </div>
                    ...
                    <div class="form-group field-customer-customer_industry required">
                        ...
                        <div class="col-sm-8">
                            <select id="game" class="form-control" name="game-company">
                                <c:forEach items="${game}" var="i">
                                    <option value="${i.id}" <c:if test="${i.id==gameArea.gameId}">selected</c:if>>${i.gameName}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <button type="button" onclick="updateGameArea()" class="btn btn-primary">修改</button>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(0== data.flag){
                    ...
                    window.location.href='../gameArea?id='+data.gameid;
                }
            },error :function (){
                alert("请求失败");
                return false;
