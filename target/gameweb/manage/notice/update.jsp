    ...
    <div class="container-fluid main-content">
        <div class="widget-container fluid-height clearfix mwi1200">
            <div class="heading clearfix">
                <i class="icon-reorder"></i> 修改公告 <i class="icon-reply pull-right" onclick="history.go(-1);"></i>
            </div>
            <div class="widget-content padded clearfix">
                <form id="actionform" class="form-horizontal" action="view/customerManage/contacts/index.jsp"
                    ...
                    <div class="form-group field-contacts-name required">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="noticetitle" class="form-control" name="Contacts[name]"
                                   maxlength="40" placeholder="请输入公告标题" value="${notice.noticeTitle}">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <button type="button" onclick="updateNotice()" class="btn btn-primary">修改</button>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(0== data.flag){
                    ...
                    window.location.href='../notice?page='+${pagenum};
                }
            },error :function (){
                alert("请求失败");
                return false;
